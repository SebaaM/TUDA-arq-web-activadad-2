...
urlpatterns = [
    ...
    # Sin header de identidad: el participante se envía explícitamente en la URL.
    path("api/v1/me/enrollments/<uuid:activity_id>/<uuid:participant_id>/", views.activity_enrollment_api_put, name="api-enrollment-confirm"),
    path("api/v1/me/enrollments/<uuid:activity_id>/<uuid:participant_id>/cancel/", views.activity_enrollment_api_delete, name="api-enrollment-cancel"),
